...
import { collection, connectFirestoreEmulator, getFirestore, onSnapshot, Unsubscribe } from "firebase/firestore";
interface City {
  State: string
  Name: string
}
...
const firebaseConfig = {
  apiKey: "Web API Key",
  authDomain: "dotnet7-firebase-demo.firebaseapp.com",
  projectId: "dotnet7-firebase-demo",
  storageBucket: "dotnet7-firebase-demo.appspot.com",
  messagingSenderId: "999651502667",
  appId: "1:999651502667:web:fc9423edda2bc2dafe7bce"
};
...
const createCity = async () => {
  ...
  const url = `http://localhost:5012/city/add/${state}/${city}`;
